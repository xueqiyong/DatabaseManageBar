...
namespace DatabaseManageBar
{
    public class DataBaseOperate
    {
        ...
        {
            string strsql = "select TownName from Town where TownCode=@code";
            SqlParameter param = new SqlParameter("code", code);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        {
            string strsql = "select CountyCode from COUNTY where CountyName=@name";
            SqlParameter param = new SqlParameter("@name", name);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        {
            string strsql = "select CountyName from COUNTY where COUNTYCode=@code";
            SqlParameter param = new SqlParameter("code", code);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        {
            string strsql = "SELECT [ProvinceCode] FROM [Province] where [ProvinceName]=@name";
            SqlParameter param = new SqlParameter("@name", name);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        {
            string strsql = "SELECT [CityCode] FROM [CITY] where [CityName]=@name";
            SqlParameter param = new SqlParameter("@name", name);
            string result = getResult(strsql, param);
            return result;
        }
        ...
        {
            string result = "";
            string strsql = string.Format("select TownCode from TOWN where TownName='{0}' and CountyCode='{1}'", name, upname);
            SqlConnection con = DataBaseOperate.getSqlCon();
            SqlCommand cmd = DataBaseOperate.getSqlCmd(strsql, con);
            SqlDataReader read = cmd.ExecuteReader(CommandBehavior.CloseConnection);
            while (read.Read())
